...
namespace Apprentice.Tools {
    ...
    // audio utilities provided by Simon Mourier, expanded by Veikka Pulsa
    ...
    public static class AudioUtilities {
        ...
        public static float? GetAppVolume(uint pid) {
        ...
        public static void SetAppVolume(uint pid, float level) {
            foreach (var session in GetAllSessions()) {
                if (session.ProcessId == pid) {
        ...
        public static void SetAppMute(uint pid, bool state) {
            foreach (var session in GetAllSessions()) {
                if (session.ProcessId == pid) {
                    session.SetMute(state);
                    break;
                }
            }
        }
        ...
        #region test
        private static ISimpleAudioVolume GetVolObj(int pid) {
            IMMDeviceEnumerator deviceEnumerator = (IMMDeviceEnumerator) (new MMDeviceEnumerator());
            deviceEnumerator.GetDefaultAudioEndpoint(EDataFlow.eRender, ERole.eMultimedia, out var speakers);

            Guid IID_IAudioSessionManager2 = typeof(IAudioSessionManager2).GUID;
            speakers.Activate(IID_IAudioSessionManager2, 0, IntPtr.Zero, out var obj);
            IAudioSessionManager2 mgr = (IAudioSessionManager2) obj;
            ...
            for (int i = 0; i < count; i++) {
                IAudioSessionControl _ctl;
                sessionEnumerator.GetSession(i, out _ctl);
                var ctl = (IAudioSessionControl2) _ctl;
        ...
        public static float? GetVol(int pid) {
            ISimpleAudioVolume volume = GetVolObj(pid);
            if (volume == null)
                return null;
    ...
    public sealed class AudioSession : IDisposable {
        ...
        #region properties
        internal AudioUtilities.IAudioSessionControl2 SessionControl { get; private set; }
        internal AudioUtilities.ISimpleAudioVolume SimpleVolume => SessionControl as AudioUtilities.ISimpleAudioVolume;
        ...
        public uint ProcessId {
            get {
                CheckDisposed();
                SessionControl.GetProcessId(out uint i);
                return i;
            }
        }
        ...
        public string Identifier {
            get {
                CheckDisposed();
                string s;
                SessionControl.GetSessionIdentifier(out s);
                return s;
            }
        }
        ...
        public string InstanceIdentifier {
            get {
                CheckDisposed();
                string s;
                SessionControl.GetSessionInstanceIdentifier(out s);
                return s;
            }
        }
        ...
        public Guid GroupingParam {
            get {
                CheckDisposed();
                Guid g;
                SessionControl.GetGroupingParam(out g);
                return g;
            }
            set {
                CheckDisposed();
                SessionControl.SetGroupingParam(value, Guid.Empty);
            }
        }
        ...
        public string DisplayName {
            get {
                CheckDisposed();
                string s;
                SessionControl.GetDisplayName(out s);
                return s;
            }
            set {
                CheckDisposed();
                ...
                SessionControl.GetDisplayName(out s);
                if (s != value) {
                    SessionControl.SetDisplayName(value, Guid.Empty);
                }
            }
        }
        ...
        public string IconPath {
            get {
                CheckDisposed();
                string s;
                SessionControl.GetIconPath(out s);
                return s;
            }
            set {
                CheckDisposed();
                ...
                SessionControl.GetIconPath(out s);
                if (s != value) {
                    SessionControl.SetIconPath(value, Guid.Empty);
                }
            }
        }
        #endregion
        ...
        public float? GetVolume() {
            var simple = SimpleVolume;
            if (simple == null)
                return null;

            simple.GetMasterVolume(out float level);
            Marshal.ReleaseComObject(simple);
            return level * 100;
        }
        ...
        public void SetVolume(float level) {
            ...
            simple.SetMasterVolume(level / 100, Guid.Empty);
            Marshal.ReleaseComObject(simple);
        }
        ...
        public void SetMute(bool state) {
            ...
            simple.SetMute(state, Guid.Empty);
            Marshal.ReleaseComObject(simple);
        }
        #endregion
